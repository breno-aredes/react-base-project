...
const About = () => {
  ...
  const membros = [
    {
      nome: "Renato Bellini",
      imagem: "imagens/perfil/renato-passeiocarioca.jpg",
      descricao: t("Sócio Fundador"),
    },
    {
      nome: "Rafael Bokor",
      imagem: "imagens/perfil/rafael-passeiocarioca.jpeg",
      descricao: t("Sócio Fundador"),
    },
  ];
  ...
  const desenvolvedores = [
    ...
    {
      nome: "Ewerton",
      imagem: "imagens/perfil/ewerton.jpg",
      descricao: t("Ciência de Dados"),
    },
    {
      nome: "João Gabriel",
      imagem: "imagens/perfil/joao.jpg",
      descricao: t("Ciência de Dados"),
    },
    {
      nome: "Miguel",
      imagem: "imagens/perfil/miguel.jpg",
      descricao: t("Ciência de Dados"),
    },
    {
      nome: "Paula",
      imagem: "imagens/perfil/paula.jpg",
      descricao: t("Eng. de Software"),
    },
  ];

  const professores = [
    {
      nome: "Eduardo Mangeli ",
      imagem: "imagens/perfil/eduardomangeli.jpg",
      descricao: t("Professor IBMEC"),
    },
  ];
          ...
          <section className="Conteudo-Equipe">
            <div className="Conteudo-Equipe-Escrito">
              ...
              <h3 className="SubTitle">
                {t("Empresa Desenvolvedora do Aplicativo")}
              </h3>
