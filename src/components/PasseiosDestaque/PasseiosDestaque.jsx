...
const PasseiosDestaque = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        {props.passeioId}
        <Titulo mostrar={ShowText ? ShowText.toString() : undefined}>
          {props.titulo}
        </Titulo>
        <img src={props.imagem} />
      </CardPasseio>
      <section className="text">
        <Local mostrar={ShowText ? ShowText.toString() : undefined}>
          {props.local}
        </Local>
        <Descricao mostrar={ShowText ? ShowText.toString() : undefined}>
          {props.descricao}
        </Descricao>
      </section>
    </PasseioDestaque>
